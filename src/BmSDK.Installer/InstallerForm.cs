...
internal sealed class InstallerForm : Form
{
    ...
    private void InitializeLayout()
    {
        ...
        {
            Text = "Choose the Batman: Arkham Knight folder to install into.",
            Location = Pt(16, 44),
            Size = Sz(532, 20),
        };
    ...
    private void UpdateStatus()
    {
        ...
        {
            SetStatus("No Arkham Knight installation was found. Use \"Choose another folder...\" to pick one yourself.");
        }
        else
        {
    ...
    private void OnBrowseClicked(object? sender, EventArgs e)
    {
        ...
        {
            Description = "Select your Batman: Arkham Knight folder",
        ...
        if (!GameDetector.IsValidGameDir(dialog.SelectedPath))
        {
            MessageBox.Show(this,
                $"That folder doesn't look like a Batman: Arkham Knight installation:\n\n{dialog.SelectedPath}\n\n"
    ...
    private async void BeginInstall()
    {
        ...
        // Installs often live under Program Files, where writing needs elevation
