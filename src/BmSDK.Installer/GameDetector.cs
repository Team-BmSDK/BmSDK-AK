...
/// <summary>
/// Locates Arkham Knight installations from the Steam launcher metadata.
/// </summary>
internal static partial class GameDetector
{
    private const string SteamAppId = "208650";
    ...
    public static List<GameInstall> DetectAll()
    {
        ...
        foreach (var install in DetectSteam())
        {
    ...
    public static bool IsValidGameDir(string? path)
    {
        ...
        try
        {
            return File.Exists(Path.Combine(path, "Binaries", "Win64", "BatmanAK.exe"))
    ...
    {
        var sdkPath = Path.Combine(gameDir, "Binaries", "Win64", "sdk", "BmSDK.dll");
